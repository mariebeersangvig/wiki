...
1. The first thing you need to do is to download the [training-config.json](https://github.com/sesam-community/wiki/blob/master/training-config.json?raw=true) and save it locally on your computer. 
