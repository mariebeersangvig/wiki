...
- [4.2 Import data](https://github.com/simenjorgensen/training/wiki#42-import-data)
#### [5 Creating our first pipe](https://github.com/simenjorgensen/training/wiki/Home#5-creating-our-first-pipe-1)
#### [6 Basic functions](https://github.com/simenjorgensen/training/wiki/Home#6-basic-functions-1)
- [6.1 Transformation](https://github.com/simenjorgensen/training/wiki/Home#61-transformation)
- [6.2 Check out the Lab](https://github.com/simenjorgensen/training/wiki#62-check-out-the-lab)
- [6.3 Merge](https://github.com/simenjorgensen/training/wiki/Home#63-merge)
- [6.3.1 Merging sources](https://github.com/simenjorgensen/training/wiki#631-merging-sources)
- [6.3.1.1 Global datasets](https://github.com/simenjorgensen/training/wiki#6311-global-datasets)
